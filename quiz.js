// Pool of questions (sample 10; extend to 100 as needed)
const questionPool = [
...
// Select random 10 questions for demo; change slice(0,10) to slice(0,50) for full quiz
...
// Load no quiz on page load; wait for user to click Start Quiz
